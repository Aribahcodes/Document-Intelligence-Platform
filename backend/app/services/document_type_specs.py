...
Fields marked as "one-off reconciling items" below (goodwill_on_consolidation,
addition_on_amalgamation, cash_acquired_on_amalgamation) are genuinely absent
from most periods (they only appear in a year where a merger/amalgamation
actually happened) - financial_validation_service.py treats these three as
0 when null, rather than triggering NOT_APPLICABLE, since their absence is
normal, not a sign of a missed extraction.
"""
...
DOCUMENT_TYPES = {
    ...
    "balance_sheet": {
        "minimum_fields": [
            ...
            "current_capital", "current_employees_stock_options", "current_reserves_and_surplus",
            "current_minority_interest", "current_deposits", "current_borrowings",
            "current_other_liabilities_and_provisions", "current_policyholders_funds",
            "current_total_capital_and_liabilities",
            "prior_capital", "prior_employees_stock_options", "prior_reserves_and_surplus",
            "prior_minority_interest", "prior_deposits", "prior_borrowings",
            "prior_other_liabilities_and_provisions", "prior_policyholders_funds",
            ...
            "current_goodwill_on_consolidation",  # one-off reconciling item, see module docstring
            ...
            "prior_goodwill_on_consolidation",  # one-off reconciling item
            "prior_total_assets",
        ],
        ...
        "description": (
            ...
            "(Capital, Employees Stock Options Outstanding, Reserves and Surplus, Minority Interest, "
            "Deposits, Borrowings, Other Liabilities and Provisions, Policyholders' Funds) versus "
            "'Assets' (Cash and balances with RBI, Balances with banks, Investments, Advances, "
            "Fixed Assets, Other Assets, Goodwill on Consolidation), each side totaling to the same "
            "figure. Shows two comparative periods (current year and prior year) side by side."
        ),
    },
    ...
    "profit_and_loss": {
        "minimum_fields": [
            ...
            "current_addition_on_amalgamation",  # one-off reconciling item, see module docstring
            ...
            "prior_addition_on_amalgamation",  # one-off reconciling item
            "prior_total_profit",
            # EPS
        ...
        "description": (
            ...
            "and Contingencies), Profit (before and after Minority Interest, brought-forward profit, "
            "occasionally an amalgamation addition), Appropriations (transfers to various reserves, "
            "dividends), and Earnings Per Share. Shows two comparative periods (current year and "
            "prior year) side by side."
        ),
    },
    ...
    "cash_flow_statement": {
        "minimum_fields": [
            ...
            "current_net_increase_in_cash", "current_cash_at_beginning",
            "current_cash_acquired_on_amalgamation",  # one-off reconciling item, see module docstring
            "current_cash_at_end",
            ...
            "prior_net_increase_in_cash", "prior_cash_at_beginning",
            "prior_cash_acquired_on_amalgamation",  # one-off reconciling item
            "prior_cash_at_end",
        ],
        "has_line_items": True,
        "has_comparative_periods": True,
        "description": (
            ...
            "of the period (occasionally including cash acquired on amalgamation). Shows two "
